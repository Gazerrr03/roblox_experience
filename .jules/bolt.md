...
## 2026-07-08 - [MonsterLogic Vector Optimization]
**Learning:** In high-frequency AI loops, standard Vector3 arithmetic and property access (.Magnitude, .Unit) incur significant metatable overhead. Performing math on raw numeric components (X, Y, Z) and using squared distance for comparisons avoids redundant object allocations and expensive square root operations.
**Action:** Always prefer raw numeric component math and squared distance comparisons in performance-critical AI or physics loops to bypass Vector3 metatable dispatch.
